...
def toggle_principle_withdrawal_block_unblock(user_id: str, admin_user_id: str):
    res = execute_query("call usp_toggle_principle_withdrawal_block_unblock(_user_id => %s, _admin_user_id => %s)",
