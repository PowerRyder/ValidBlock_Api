...
def get_polygon_validator_transactions(page_index: int, page_size: int):
    res = execute_query("call usp_get_polygon_validator_transactions(_page_index =>%s, _page_size => %s)",
                        (page_index, page_size))
    return res
